...
export function loadDefaultLayout(assetsRoot: string): Record<string, any> | null {
  try {
...
export async function loadCharacterSprites(assetsRoot: string): Promise<{ characters: any[] } | null> {
  try {
